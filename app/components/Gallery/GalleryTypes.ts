...
export const GALLERY_ITEMS: GalleryItem[] = [
    {
        id: 2,
        type: "video",
        src: "/Gallery/mscolorreklam.mov",
        thumb: "/Gallery/mscolorreklam.mov",
        alt: "GyroMix Afiş",
    },
    {
        id: 2,
        type: "video",
        src: "/Gallery/MasterTintReklam.mp4",
        thumb: "/Gallery/MasterTintReklam.mp4",
        alt: "GyroMix Afiş",
    },
    {
        id: 3,
        type: "video",
        src: "/Gallery/mscolorreklam2.mov",
        thumb: "/Gallery/mscolorreklam2.mov",
